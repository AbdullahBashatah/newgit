...
function _default(config, env) {
  ...
  webpackConfig = (0, _webpackMerge["default"])(webpackConfig, {
    ...
    new _StyleguidistOptionsPlugin["default"](config), new _miniHtmlWebpackPlugin.MiniHtmlWebpackPlugin(htmlPluginOptions), new _webpack["default"].DefinePlugin({
  ...
  if (isProd) {
    ...
    webpackConfig = (0, _webpackMerge["default"])({
      ...
      plugins: [new _webpack["default"].HotModuleReplacementPlugin(), new _webpack["default"].ProvidePlugin({
